...
#define AppName "APEX" Add Your Game Name
#define Name "APEX" Add Your GAme Name
#define Shortname "APEX" Add Your Game Desktop Shortcut Name
#define AppPublisher "Repack By APEX" Add Your Repack Name
#define AppVersion "1.0.0.0" Add Your Game Version
#define AppExec "Folder\APEX.exe" Add Your Game Launcher Name And Launcher Dir/Folder Name
#define AppSize "100" Add Your Game Minimum Space  
#define Spacesize "100" Add Your Game Totall Space               
...
AppComments=Add Your Uninstall Comments
AppId={#Name} ~ {#AppPublisher}
DefaultDirName=D:\Games\{#AppName} Add Your Game Install Dir Path
...
AppCopyright=APEX2022,Inc. Add Your Copyright
